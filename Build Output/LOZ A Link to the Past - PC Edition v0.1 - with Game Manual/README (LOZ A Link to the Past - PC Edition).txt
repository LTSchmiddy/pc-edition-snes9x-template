...
I actually started working on this about halfway through my development of SMPCE. While I had it mostly finished at about that time, there was having difficulty finding the memory address of a specific variable. After playing with it on and off for the last couple months, I stumbled on the solution somewhat by accident. After implementing it, I feel confident that this is ready for it's first public release.
...
I've also included PDF copies of the original game manual (since this was released back when games had those) and the two additional hint/lore foldouts that came with the original game. These can be found in the 'Docs' folder. I acquired all three files from http://zeldacapital.com/manuals.php . Great resource. Show 'em some love. :)
